...
```
mlops-project-stijn         <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_project_stijn       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
